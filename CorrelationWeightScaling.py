...
# scaling_factors = (mean_correlations - mean_correlations.min()) / (
#     mean_correlations.max() - mean_correlations.min()
# )
...
for i in range(weights.shape[0]):
    ...
    new_weights = SNN.connections["0", "1"].w[:, i] * scaling_factor * scaling_factor
    SNN.connections["0", "1"].w[:, i] = new_weights
