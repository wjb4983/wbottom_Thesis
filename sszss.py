...
n_neurons = n_filters * conv_size * conv_size
...
for epoch in range(n_epochs):
    ...
    for step, batch in enumerate(tqdm(train_dataloader)):
        ...
        if (step + 1) * batch_size % update_interval == 0 and step > 0:
        ...
        if batch_size > 1:
            ...
            print("\nX",_spikes["X"].sum(), "/", batch_size, "=", _spikes["X"].sum()/batch_size)
            print("Y",_spikes["Y"].sum(), "/", batch_size, "=", _spikes["Y"].sum()/batch_size)
