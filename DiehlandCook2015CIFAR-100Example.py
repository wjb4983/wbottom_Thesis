...
parser.add_argument("--intensity", type=float, default=20)
...
network = DiehlAndCook2015(
    n_inpt=32 * 32 * 3,  # Adjusted input size for CIFAR-100 images
    n_neurons=n_neurons,
    exc=exc,
    inh=inh,
    dt=dt,
    ...
    inpt_shape=(3, 32, 32),  # Adjusted input shape for CIFAR-100 images
)
