...
parser.add_argument("--inh", type=float, default=60.0)
...
class LIFNET(Network):
    def __init__(self, n_inpt, n_neurons, exc, inh, dt, theta_plus, inpt_shape, norm=1, nu = (1e-4,1e-2)):
...
for epoch in range(n_epochs):
    ...
    for step, batch in enumerate(tqdm(train_dataloader)):
        ...
        s = spikes[f"Y"].get("s").permute((1, 0, 2))
