...
#             constant.
#         :param theta_plus: On-spike increment of membrane
#             threshold potential.
#         :param tc_theta_decay: Time constant of threshold
#             potential decay.
...
class LIFNET(Network):
    def __init__(self, n_inpt, n_neurons, exc, inh, dt, theta_plus, tc_theta_decay, inpt_shape):
        super().__init__(dt=dt)
        self.n_inpt = n_inpt
        self.inpt_shape = inpt_shape
        self.n_neurons = n_neurons
        ...
        # Connections
        input_exc_conn = Connection(
            source=input_layer, target=exc_layer, w=0.3 * torch.rand(self.n_inpt, self.n_neurons),
